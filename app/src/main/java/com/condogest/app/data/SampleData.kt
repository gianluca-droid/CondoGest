...
object SampleData {
    suspend fun populateDatabase(repository: CondoRepository): Long {
        ...
        val units1 = listOf(
            CondoUnit(condominioId = condoId1, number = "1", floor = 0, type = "Locale",        areaMq = 45.0,  millesimi = 55.0,  ownerName = "Mario Bianchi",    ownerEmail = "mario.bianchi@email.it",  ownerPhone = "333 1001001"),
            CondoUnit(condominioId = condoId1, number = "2", floor = 1, type = "Appartamento",  areaMq = 85.0,  millesimi = 125.0, ownerName = "Lucia Verdi",      ownerEmail = "lucia.verdi@email.it",    ownerPhone = "339 2002002"),
            CondoUnit(condominioId = condoId1, number = "3", floor = 1, type = "Appartamento",  areaMq = 70.0,  millesimi = 105.0, ownerName = "Giuseppe Russo",   ownerEmail = "g.russo@email.it",        ownerPhone = "347 3003003"),
            CondoUnit(condominioId = condoId1, number = "4", floor = 2, type = "Appartamento",  areaMq = 95.0,  millesimi = 140.0, ownerName = "Anna Ferrari",     ownerEmail = "anna.ferrari@email.it",   ownerPhone = "328 4004004"),
            CondoUnit(condominioId = condoId1, number = "5", floor = 2, type = "Appartamento",  areaMq = 80.0,  millesimi = 120.0, ownerName = "Paolo Esposito",   ownerEmail = "p.esposito@email.it",     ownerPhone = "366 5005005"),
            CondoUnit(condominioId = condoId1, number = "6", floor = 3, type = "Appartamento",  areaMq = 110.0, millesimi = 160.0, ownerName = "Francesca Romano", ownerEmail = "f.romano@email.it",       ownerPhone = "345 6006006"),
            CondoUnit(condominioId = condoId1, number = "7", floor = 3, type = "Appartamento",  areaMq = 75.0,  millesimi = 110.0, ownerName = "Marco Colombo",    ownerEmail = "m.colombo@email.it",      ownerPhone = "320 7007007"),
            CondoUnit(condominioId = condoId1, number = "8", floor = 4, type = "Appartamento",  areaMq = 120.0, millesimi = 185.0, ownerName = "Sara Ricci",       ownerEmail = "sara.ricci@email.it",     ownerPhone = "351 8008008")
        )
        ...
        listOf(
            ...
            Payment(unitId = unitIds1[1], amount = 520.0, date = daysAgo(95),  method = "Portale",  reference = "PRT-2026-012"),
            Payment(unitId = unitIds1[2], amount = 430.0, date = daysAgo(90),  method = "Cedolino", reference = "CED-2026-003"),
            Payment(unitId = unitIds1[3], amount = 580.0, date = daysAgo(85),  method = "Bonifico", reference = "BON-2026-004"),
            Payment(unitId = unitIds1[7], amount = 750.0, date = daysAgo(20),  method = "Portale",  reference = "PRT-2026-033")
